...
# For example, if the dictionary is in English,
...
def date_converter(month_dict, date_string):
    """
    Takes two inputs: a dictionary of months and month numbers
    and a date in 'mm/dd/yyyy' format. Return the date in
    'day month year' format.
    """
    month, day, year = date_string.split("/")
    return day + " " + english[int(month)] + " " + year


print(date_converter(english, '05/11/2012'))
# >>> 11 May 2012
